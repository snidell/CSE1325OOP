...
import java.text.*;
import java.util.*;
public class EnterpriseBACKUP implements Proj3Constants, DateConstants{
  
 private String name;
 private ArrayList<Item> items;
 private ArrayList<SalariedEmp> employees;
 ...
 /**
  * Prints Main menu for project 3 User Interface
  *
  */
  public void printMenu2(){
    System.out.println(this);
    System.out.println("Welcome to MavBay! Project3");
    System.out.println("Main Menu:");
    System.out.println(  "10) Show Menu for Proj 2");
    System.out.println(  "11) Post item for sale");
    System.out.println(  "12) Add new customer");
    System.out.println(  "13) Display items sold");
    System.out.println(  "14) Display total fee collection");
    System.out.println(  "15) Display Items that received max bid");
    System.out.println(  "16) Release an employee");
    System.out.println(  "17) Release an employee");
    System.out.println(  "18) Release an employee");
    System.out.println(  "19) Release an employee");
    System.out.println(  "0) Exit Program");  
  }
  /**
